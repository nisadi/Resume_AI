...
const PersonalInfoForm = ({data, onChange, removeBackground, setRemoveBackground,}) => {
  ...
  return (
    <div>
      ...
      <p className='text-sm text-gray-600'>Get Strted With The Personal Information</p>
      <div className='flex items-center gap-2'>
        <label>
            {data.image ? (
                ...
                <div>
                    <User className='size-12 p-2.5 border rounded-full'/>
                    upload user image
                </div>
            )}
        ...
        {typeof data.image === 'object' && (
            <div className='flex p-6 flex-col gap-1 pl-5  text-sm'>
                <p>Remove Back Ground</p>
                <label className='relative inline-flex item-center cursor-pointer text-gray-900 gap-4'>
