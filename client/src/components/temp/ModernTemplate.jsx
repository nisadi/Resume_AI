    ...
    <div className="max-w-4xl mx-auto bg-white text-gray-800">
      ...
      <div className="p-8">
        ...
        {data.project?.length > 0 && (
          <section className="mb-8">
            <h2 className="text-2xl font-light mb-4 pb-2 border-b">Projects</h2>
            ...
            <div className="space-y-6">
              {data.project.map((p, index) => (
                ...
                >
                  ...
                  {/* ✅ Project Type */}
                  {p.type && (
                    <p className="text-sm text-gray-500 italic">{p.type}</p>
                  )}
        ...
        <div className="grid sm:grid-cols-2 gap-8">
          ...
          {data.skills?.length > 0 && (
            <section>
              <h2 className="text-2xl font-light mb-4 pb-2 border-b">Skills</h2>
