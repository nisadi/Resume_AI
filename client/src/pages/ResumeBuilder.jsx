...
import { ArrowLeft, Briefcase, GraduationCap, Sparkles, User, FileText, Folder, ChevronLeft, ChevronRight, Share2Icon, EyeIcon, EyeOffIcon, DownloadIcon } from "lucide-react";
            ...
            <div className="lg:col-span-7 max-lg:mt-6">
              <div className="relative w-full">
                <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                  ...
                  <button onClick={changeResumeVisibility} className="flex items-center py-2 px-6 gap-2 text-xs bg-gradient-to-br from-purple-100 to-purple-200 text-purple-600
